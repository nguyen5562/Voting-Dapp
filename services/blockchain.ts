...
import address from '@/build/contractAddress.json'
import abi from '@/build/contracts/DappVotes.json'
import { ContestantStruct, PollParams, PollStruct } from '@/utils/types'
import { structureContestants, structurePolls } from '@/utils/helper'
